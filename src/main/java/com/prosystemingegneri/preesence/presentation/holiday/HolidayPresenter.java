...
@Named
@ViewScoped
public class HolidayPresenter implements Serializable{
    @Inject
    private HolidayService service;
    
    public void updateBankHolidaysCurrentYear() {
        service.updateBankHolidaysCurrentYear();
        
        Messages.create("success").detail("holiday.holidayUpdater.success").flash().add();
    }
}
